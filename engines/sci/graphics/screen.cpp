...
GfxScreen::GfxScreen(ResourceManager *resMan) : _resMan(resMan) {
	...
	if (((g_sci->getPlatform() == Common::kPlatformWindows) || (g_sci->forceHiresGraphics())) && _upscaledHires != GFX_SCREEN_UPSCALED_DISABLED) { //AL TODO: Hack fix
	...
	switch (_upscaledHires) { //Here is the size issue
